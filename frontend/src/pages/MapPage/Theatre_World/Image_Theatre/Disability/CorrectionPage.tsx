...
function DisabilityCorrectionPage() {
    ...
    if (!state || !state.analysisResult) {
        return (
            <WorldPageLayout
                backgroundImage="/Theatre/Image_Theatre/Disability2.png"
                altText="Disability Review"
                onBackClick={handleBackClick}
            >
                <div className="cr-correction-container">
                    <h2 className="difficulty-selection-title">Disability Quiz Review</h2>
                    <p className="difficulty-selection-description">
                        No analysis data found. Please complete the Disability quiz first.
                    </p>
        ...
        >
            <div className="cr-correction-container" style={{ overflowY: 'auto', maxHeight: '100%' }}>
                ...
                <p className="difficulty-selection-description">
                    ...
                    understanding of Disability topics in Image Theatre.
                </p>
...
export default DisabilityCorrectionPage;
