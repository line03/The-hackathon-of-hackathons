...
function SportsPage() {
    ...
    const [userAnswers, setUserAnswers] = useState<SportsUserAnswer[]>([]);
        ...
        const runAnalysis = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    navigate(ROUTES.THEATRE_WORLD_IMAGE_THEATRE_SPORTS_CORRECTION, {
                        state: {
                            analysisResult: data,
                            score,
    ...
    if (!quizStarted) {
        if (!mainQuizCompleted) {
            return (
                <WorldPageLayout backgroundImage="/Theatre/Image_Theatre/Image_Theatre.png" altText="Sports Quiz" onBackClick={handleBackClick}>
