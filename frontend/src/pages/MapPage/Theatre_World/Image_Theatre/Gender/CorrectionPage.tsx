...
function GenderCorrectionPage() {
    ...
    if (!state || !state.analysisResult) {
        return (
            <WorldPageLayout
                backgroundImage="/gender.png"
                altText="Gender Review"
                onBackClick={handleBackClick}
            >
                <div className="cr-correction-container">
                    <h2 className="difficulty-selection-title">Gender Quiz Review</h2>
                    <p className="difficulty-selection-description">
                        No analysis data found. Please complete the Gender quiz first.
                    </p>
        ...
        >
            <div className="cr-correction-container" style={{ overflowY: 'auto', maxHeight: '100%' }}>
                ...
                <p className="difficulty-selection-description">
                    ...
                    understanding of Gender topics in Image Theatre.
                </p>
...
export default GenderCorrectionPage;
