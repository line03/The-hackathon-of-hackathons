...
function ImageTheatreCorrectionPage() {
    const location = useLocation();
    const navigate = useNavigate();
    const state = location.state as CorrectionState | null;

    const handleBackClick = () => {
        navigate(ROUTES.THEATRE_WORLD_IMAGE_THEATRE);
    };
    ...
    if (!state || !state.analysisResult) {
        return (
            <WorldPageLayout
                ...
                altText="Image Theatre Review"
                onBackClick={handleBackClick}
            >
                <div className="cr-correction-container">
                    <h2 className="difficulty-selection-title">Image Theatre Review</h2>
                    <p className="difficulty-selection-description">
                        No analysis data found. Please complete the Image Theatre quiz first.
                    </p>
                    <button className="submit-button" onClick={handleBackClick}>
                        Back to Image Theatre
                    </button>
                </div>
            </WorldPageLayout>
        );
    ...
    return (
        ...
        >
            <div className="cr-correction-container" style={{ overflowY: 'auto', maxHeight: '100%' }}>
                <h2 className="difficulty-selection-title">Image Theatre Quiz Review</h2>
                <p className="difficulty-selection-description">
                    Here is a personalized breakdown of your answers, with explanations to help you deepen your
                    understanding of Image Theatre.
                </p>
...
export default ImageTheatreCorrectionPage;
