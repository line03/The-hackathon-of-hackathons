...
function PeaceAgendaCorrectionPage() {
    ...
    if (!state || !state.analysisResult) {
        return (
            <WorldPageLayout
                ...
                altText="Peace Agenda Review"
                onBackClick={handleBackClick}
            >
                <div className="cr-correction-container">
                    <h2 className="difficulty-selection-title">Peace Agenda Quiz Review</h2>
                    <p className="difficulty-selection-description">
                        No analysis data found. Please complete the Peace Agenda quiz first.
                    </p>
                    <button className="submit-button" onClick={handleBackClick}>
                        Back to Peace Agenda
                    </button>
                </div>
            </WorldPageLayout>
        );
        ...
        >
            <div className="cr-correction-container" style={{ overflowY: 'auto', maxHeight: '100%' }}>
                ...
                <p className="difficulty-selection-description">
                    ...
                    understanding of Peace Agenda topics in Image Theatre.
                </p>
...
export default PeaceAgendaCorrectionPage;
