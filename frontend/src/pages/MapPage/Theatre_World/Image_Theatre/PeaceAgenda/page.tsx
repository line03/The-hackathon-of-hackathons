...
interface PeaceAgendaUserAnswer {
    question: string;
    answerOptions: Question['answerOptions'];
    answerCorrect: boolean;
}

function PeaceAgendaPage() {
    ...
    const [userAnswers, setUserAnswers] = useState<PeaceAgendaUserAnswer[]>([]);
        ...
        const runAnalysis = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    navigate(ROUTES.THEATRE_WORLD_IMAGE_THEATRE_PEACE_AGENDA_CORRECTION, {
                        state: {
                            analysisResult: data,
                            score,
    ...
    if (!quizStarted) {
        if (!mainQuizCompleted) {
            return (
                <WorldPageLayout backgroundImage="/Theatre/Image_Theatre/Image_Theatre.png" altText="Peace Agenda Quiz" onBackClick={handleBackClick}>
...
export default PeaceAgendaPage;
