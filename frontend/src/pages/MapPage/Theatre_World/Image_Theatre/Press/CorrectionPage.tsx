    ...
    if (!state || !state.analysisResult) {
        return (
            <WorldPageLayout
                ...
                altText="Press Review"
                onBackClick={handleBackClick}
            >
                <div className="cr-correction-container">
                    <h2 className="difficulty-selection-title">Press Quiz Review</h2>
                    <p className="difficulty-selection-description">
                        No analysis data found. Please complete the Press quiz first.
                    </p>
        ...
        >
            <div className="cr-correction-container" style={{ overflowY: 'auto', maxHeight: '100%' }}>
                ...
                <p className="difficulty-selection-description">
                    ...
                    understanding of Press topics in Image Theatre.
                </p>
...
export default PressCorrectionPage;
