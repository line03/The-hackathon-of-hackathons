...
function PressPage() {
    ...
    const [userAnswers, setUserAnswers] = useState<PressUserAnswer[]>([]);
        ...
        const runAnalysis = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    navigate(ROUTES.THEATRE_WORLD_IMAGE_THEATRE_PRESS_CORRECTION, {
                        state: {
                            analysisResult: data,
                            score,
    ...
    if (!quizStarted) {
        if (!mainQuizCompleted) {
            return (
                <WorldPageLayout backgroundImage="/Theatre/Image_Theatre/Image_Theatre.png" altText="Press Quiz" onBackClick={handleBackClick}>
