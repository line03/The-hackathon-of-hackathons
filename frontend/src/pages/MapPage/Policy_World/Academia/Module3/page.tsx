...
import quizData from '../quiz_module3.json';
import '../page.css';
...
const MODULE_VIDEO = '/Policy-world/Videos/Module_3.mp4';
        ...
        const runAnalysis = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    navigate(ROUTES.POLICY_WORLD_ACADEMIA_MODULE_3_CORRECTION, {
                        state: {
                            analysisResult: data,
                            score,
                            moduleId: 3,
    ...
    if (phase === 'video') {
        return (
            <WorldPageLayout
                ...
                altText="Module 3 - Corruption & Comparative Politics"
