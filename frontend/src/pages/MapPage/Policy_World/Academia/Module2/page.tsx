...
import quizData from '../quiz_module2.json';
import '../page.css';
...
// Using Module1 video as placeholder since Module2 video may not exist
        ...
        const runAnalysis = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    navigate(ROUTES.POLICY_WORLD_ACADEMIA_MODULE_2_CORRECTION, {
                        state: {
                            analysisResult: data,
                            score,
                            moduleId: 2,
    ...
    if (phase === 'video') {
        return (
            <WorldPageLayout
                ...
                altText="Module 2 - Corruption & Good Governance"
